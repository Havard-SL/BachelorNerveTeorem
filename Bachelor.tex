...
\begin{lemma} % alpha avbildninga??
	For ei endeleg mengda av lukka, kompakte delmengder \( U_i \subseteq \Rb^d \), med \( U = \set{U_i}_{i=1}^n \). Vidare la \( \Psi \) vera som i \ref{thm:Psi}, og \( \gr{\Sd(\Nc(U))}_f \) ein geometrisk realisering av nerva til \( U \) med hensyn til ein affin imbeddinga \( f \). 
