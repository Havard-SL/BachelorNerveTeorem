...
\begin{lemma} % alpha avbildninga??
	For ei endeleg mengda av lukka, kompakte delmengder \( U_i \subseteq \Rb^d \), med \( U = \set{U_i}_{i=1}^n \). Vidare la \( \Psi \) vera som i \autoref{def:Psi}, og \( \gr{\Sd(\Nc(U))}_f \) ein geometrisk realisering av den barysentriske oppdelinga til nerva av \( U \) med hensyn til den affine imbeddinga \( f \). 
