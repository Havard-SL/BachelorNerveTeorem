...
\begin{example}
	...
	\begin{figure}[htbp]
		...
		\end{center}
		\caption{Her har me tre eksempel på mengder av delmengder i \( \Rb^2 \) og den geometriske realiseringa av nerva deira.}
	\end{figure}
\end{example}
...
\begin{definition} % Definer open ball TODO
...
\begin{proof}
	...
	\] % Finskriva med A og A^\epsilon? TODO
...
% Burde refera til eit lemma om sum av kont avb er kont? TODO
\begin{proof} 
...
\end{lemma}
 ...
 % Trenge fleire forkunskapar om kvifor ting er kontinuerleg TODO?
\begin{proof}
