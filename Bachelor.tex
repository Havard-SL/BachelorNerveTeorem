...
\begin{theorem}
	(Opent, samantrekkbart snitt) La $V$ vera eit topologisk rom (ikkje nødvendigvis eit vektorrom), med \( X \subseteq V \) ei delmengda med underromstopologien. Vidare, la $F$ vera eit endeleg ope overdekke av $X$ med samantrekkbart snitt.
