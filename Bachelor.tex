...
\begin{center}
	\begin{tikzcd}
		...
		\vline K\vline_f \arrow[dashed]{r}{\hat{\tau}_f} \arrow[hook]{u}
		& \vline K\vline_{\hat{f}} \arrow{r}{\hat{L}} \arrow[hook]{u}
		& \vline K\vline_{\hat{g}} \arrow[hook]{u}
		& \vline K\vline_g \arrow[dashed]{l}[swap]{\hat{\tau}_g} \arrow[hook]{u}
	\end{tikzcd}
\end{center}
